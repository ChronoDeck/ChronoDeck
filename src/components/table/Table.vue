<template>
        <div class="w-full h-full rounded-md flex flex-row tableContainer overflow-visible" id="tableContainer">
            <div 
            v-for="level_id in level_id_list"
            :key="level_id"
            ...
            >
                ...
                width: tableContainer?.offsetWidth * columnPercentage - 30 + 'px'
                    ...
                    >
                        ...
                        >
                            <Section
                            v-for="parent_id in groupLevelByParentId(level_id, selectionTree, align_id, alignLevel)"
                            :key = parent_id
                    ...
                    >
                        <Section
                        v-for="parent_id in groupLevelByParentId(level_id, selectionTree, 1, 1)"
                        :key = parent_id
